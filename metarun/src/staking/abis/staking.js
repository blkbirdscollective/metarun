const stakingAbi = [
  ...
  {
    inputs: [],
    name: 'earlyPoolRewardPercent',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [{ internalType: 'address', name: '_userAdd', type: 'address' }],
    name: 'earlyStakeTimeRemaining',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'rewardUnWithdrawed', type: 'uint256' },
      { internalType: 'uint256', name: 'earlyRewardUnWithdrawed', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
