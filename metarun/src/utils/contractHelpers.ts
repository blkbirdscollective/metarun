...
import {
  ...
  getNftCreationAddress,
  getChestOpeningAddress
...
import nftCreationAbi from 'config/abi/nftCreation.json'
import chestOpeningAbi from 'config/abi/chestOpening.json'
...
export const getNftCreationContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(nftCreationAbi, getNftCreationAddress(), signer)
}

export const getChestOpeningContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(chestOpeningAbi, getChestOpeningAddress(), signer)
}