...
export const getCustomMeta = (path: string, t: ContextApi['t']): PageMeta => {
  ...
  if (path.startsWith('/swap')) {
    ...
    basePath = '/stake'
  } else if (path.startsWith('/lp-farm')) {
    basePath = '/lp-farm'
  ...
  switch (basePath) {
    case '/':
      return {
        title: `${t('Home')} | ${t('Metarun')}`,
      }
    case '/swap':
      return {
        title: `${t('Swap')} | ${t('Metarun')}`,
      }
    case '/add':
      return {
        title: `${t('Add Liquidity')} | ${t('Metarun')}`,
      }
    case '/remove':
      return {
        title: `${t('Remove Liquidity')} | ${t('Metarun')}`,
      }
    case '/liquidity':
      return {
        title: `${t('Liquidity')} | ${t('Metarun')}`,
      }
    case '/stake':
      return {
        title: `${t('Stake')} | ${t('Metarun')}`,
      }
    case '/lp-farm':
      return {
        title: `${t('Liquidity Farm')} | ${t('Metarun')}`,
      }
