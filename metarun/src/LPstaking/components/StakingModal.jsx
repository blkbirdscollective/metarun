...
import { CardBody, CardFooter } from '@blkbirds/uikit'
...
export default function StakingModal({ contract, poolNumber, token, isTriggerDisabled, isStaking, onRefetch }) {
  ...
  //   onClose()
  // }, [tokenContract, amount, account, contract, toast, onClose])
  ...
  //  if(!provider) return;
  //   contract
  //     .stakePool(poolNumber, numberOfTokens.toString())
  //     .then((response) => {
  //  if(!provider) return;
